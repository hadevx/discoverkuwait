      ...
      >
        <defs>
          ...
          <filter id="soft" x="-20%" y="-20%" width="140%" height="140%">
            <feDropShadow dx="0" dy="3" stdDeviation="6" floodColor="oklch(0.3 0.04 230)" floodOpacity="0.18" />
          </filter>
        </defs>
          ...
          return (
            <g key={g.id}>
              ...
              <text
                ...
                textAnchor="middle"
                pointerEvents="none"
                className="fill-[oklch(0.22_0.03_240)] text-[15px] font-extrabold"
        ...
        <g transform="translate(56, 545)" pointerEvents="none" opacity="0.7">
          ...
          <text y="-20" textAnchor="middle" className="fill-[oklch(0.4_0.03_230)] text-[10px] font-bold">
            N
          </text>
        </g>
      </svg>
